...
module User::GeneratedAssociationMethods
  ...
  sig { returns(::User::Export::ActiveRecord_Associations_CollectionProxy) }
  def exports; end

  sig { returns(T::Array[Integer]) }
  def export_ids; end

  sig { params(value: T::Enumerable[::User::Export]).void }
  def exports=(value); end

  sig { returns(::GoogleAccount::ActiveRecord_Associations_CollectionProxy) }
  ...
  sig { returns(::Meeting::ActiveRecord_Associations_CollectionProxy) }
  def meetings; end

  sig { returns(T::Array[Integer]) }
  def meeting_ids; end

  sig { params(value: T::Enumerable[::Meeting]).void }
  def meetings=(value); end
