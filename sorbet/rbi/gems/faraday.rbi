...
class Anonymous_Faraday_Options_450 < Faraday::Options
  def bind; end
  def bind=(_); end
  def boundary; end
  def boundary=(_); end
...
class Faraday::RequestOptions < Anonymous_Faraday_Options_450
  def []=(key, value); end
end
class Anonymous_Faraday_Options_451 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_451
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_452 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_452
...
class Anonymous_Faraday_Options_453 < Faraday::Options
  def builder; end
  def builder=(_); end
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_453
  def builder_class; end
  def new_builder(block); end
  def request; end
  def ssl; end
end
class Anonymous_Faraday_Options_454 < Faraday::Options
  def body; end
  def body=(_); end
  def method; end
  def method=(_); end
...
class Faraday::Env < Anonymous_Faraday_Options_454
  def [](key); end
  def []=(key, value); end
  def clear_body; end
...
class Faraday::Request < Anonymous_Struct_455
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
